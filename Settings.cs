...
namespace 破片压缩器 {
    public static class Settings {
        ...
        public static string str视频编码库, str音频编码格式;
        ...
        public static string Get_视频编码库(VideoInfo info, out string str多线程编码库, out float adjust_crf, out string preset, out string denoise) {
            preset = string.Empty;
